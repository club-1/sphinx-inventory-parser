...
class SphinxInventoryParser
{
	 ...
	 *
	 * @param string $url The URL of the documentation's root, with or without the trailing slash. It is used both as the location to fetch the inventory and as the base for the :attr:`SphinxObject::$uri`.
